...
def build_star_photons_for_observer(
    ...
    catalog_name = NEBULA_STAR_CATALOG.get("name", "Gaia")
    catalog_band = NEBULA_STAR_CATALOG.get("band", "G")
...
def run_star_photons_pipeline_from_pickles(
    ...
    catalog_name = NEBULA_STAR_CATALOG.get("catalog_name", "UNKNOWN_CATALOG")
